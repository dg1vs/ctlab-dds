...
TOOL_PREFIX =  /usr/local/AVRMacPack
TOOL_EXE_SUFFIX =
# MCU name
MCU = atmega32
...
SRC = parser.c timer.c dds-hw.c dds-parser.c encoder.c i2c.c i2creg.c lcd.c \
	panel.c main.c uart.c
...
CDEFS = -DF_CPU=$(F_CPU)UL -DUART_BAUDRATE=38400 -DUART_2X
...
# tight size optimization
CFLAGS += -fno-inline-small-functions -fno-split-wide-types 
CFLAGS += -fno-tree-scev-cprop -ffreestanding
...
#
AVRDUDE_PROGRAMMER = pony-stk200 #stk500
